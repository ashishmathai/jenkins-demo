job('NodeJS_dsl_test01') {
	...
	shell(sshpass -p 'ashish' ssh -o StrictHostKeyChecking=no ashish@192.168.0.112 "date; date >> /tmp/date")
	shell(sshpass -p 'ashish' ssh ashish@192.168.0.112 "sudo mkdir -p /opt/NodeProject/; sudo chown -R ashish:ashish /opt/NodeProject; cd /opt/NodeProject; git clone https://github.com/ashishmathai/nodejssample.git; cd /opt/NodeProject/nodejssample/; npm install; node index.js &")
